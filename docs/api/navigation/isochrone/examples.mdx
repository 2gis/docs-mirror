...
По умолчанию можно задать до пяти промежутков времени, каждый из которых не превышает 3600 секунд. Чтобы увеличить длительность промежутков сверх лимита в 3600 секунд, напишите в [отдел продаж <Brand />](https://dev.2gis.ru/api/routing#form).
