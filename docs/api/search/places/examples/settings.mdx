...
Чтобы использовать поиск с единственным филиалом, отправьте GET-запрос к [/3.0/items](/api/search/places/reference/3.0/items) со следующими параметрами:
...
Чтобы использовать поиск внутри здания, отправьте GET-запрос к [/3.0/items](/api/search/places/reference/3.0/items) со следующими параметрами:
...
Чтобы использовать поиск рядом с пользователем, отправьте GET-запрос к [/3.0/items](/api/search/places/reference/3.0/items) со следующими параметрами:
...
Чтобы задать область поиска, отправьте GET-запрос к [/3.0/items](/api/search/places/reference/3.0/items) со следующими параметрами:
...
Чтобы указать способ ввода запроса, отправьте GET-запрос к [/3.0/items](/api/search/places/reference/3.0/items) со следующими параметрами:
...
Чтобы включить проверку завершения ввода, отправьте GET-запрос к [/3.0/items](/api/search/places/reference/3.0/items) со следующими параметрами:
