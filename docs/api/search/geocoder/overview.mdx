...
<PlaygroundPreview
  id="geocoder"
  name="Geocoder API"
  description="Получите координаты по адресу или адрес по координатам"
  tags={["Геокодинг", "Подсказки"]}
  href="playground/geocoder/?utm_source=docs&utm_medium=referral&utm_campaign=api_geocoder"
/>
