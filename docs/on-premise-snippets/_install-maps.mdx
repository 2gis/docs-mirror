...
### 6.3. Установите сервисы карт {#install-map-services}
...
### 6.4. Проверьте работоспособность установленных сервисов {#test-maps}
...
Чтобы подключить пользовательский стиль карты, установите [Менеджер Платформы](/on-premise-api-platform/installation#install-pm) и выполните шаги по [загрузке и применению стиля](/on-premise-api-platform/user-guide/platform-manager#adding-map-style).
